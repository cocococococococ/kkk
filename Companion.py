    ...
    if st.button("🤗 Spin up your companion"):
        ...
        if youtube_video_url:
            with st.spinner("Companion is watching the video 👀..."):
                ...
                #     youtube_video_url,
                # )
                st.warning("Long term memory feature requires steamship installation")
    ...
    if prompt := st.chat_input():
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                # 模拟响应
                responses = [f"I received your message: '{prompt}'. This is a demo response since steamship is not installed."]
